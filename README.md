...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-12-01 09:27`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c997fd64-21f7-431c-ad2f-8ca736fad791.git
$ cd c997fd64-21f7-431c-ad2f-8ca736fad791
```
